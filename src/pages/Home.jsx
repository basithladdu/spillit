  ...
  function Home() {
    ...
    useEffect(() => {
      ...
      Object.entries(allIssues).forEach(([id, issue]) => {
        ...
        const popupHtml = `
          <div style="font-family: sans-serif; min-width: 240px; background: #0F172A; border: 1px solid ${sevStyle.border}; border-radius: 12px; overflow: hidden; color: white;">
            ...
            <div style="padding: 15px;">
              ${issue.imageUrl ? `<div style="width: 100%; height: 100px; background-image: url('${issue.imageUrl}'); background-size: cover; background-position: center; border-radius: 6px; margin-bottom: 10px; border: 1px solid #334155;"></div>` : ''}
    ...
    return (
      <div className="relative w-full h-screen overflow-hidden bg-[#0A0A1E] text-white font-sans">
        ...
        <motion.nav 
          ...
          className="fixed top-6 left-0 right-0 z-[1000] flex items-center justify-between px-6 pointer-events-none"
        >
          {/* Glass Pill Menu */}
        ...
        {/* --- HUD: Floating Controls (Bottom Right) --- */}
        <div className="fixed bottom-24 right-6 z-[900] flex flex-col gap-4 items-end pointer-events-auto">
        ...
        {/* --- HUD: Branding (Bottom Left) --- */}
        <div className="fixed bottom-8 left-8 z-[900] pointer-events-none">
            ...
            <div className="fixed inset-0 z-[2000] flex items-center justify-center p-4">
              ...
              >
                  ...
                  <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    <div className="grid grid-cols-2 gap-5">
                        <div className="space-y-1">
                          ...
                          <select 
                            ...
                            className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-3 text-white text-sm outline-none focus:border-cyan-500 transition"
                          >
                    ...
                    <button type="submit" className="w-full py-3.5 bg-gradient-to-r from-cyan-600 to-blue-600 rounded-xl text-white font-bold shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40 transition-all flex items-center justify-center gap-2">
